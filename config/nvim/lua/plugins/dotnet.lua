...
return {
	{
		...
		keys = {
			{ "<leader>/", mode = { "n", "v" } },
			{
				"<leader>nb",
				function()
					run_dotnet_for_target("build")
				end,
				mode = "n",
				desc = ".NET build target",
				silent = true,
			},
			{
				"<leader>nB",
				function()
					run_dotnet_for_project("build")
				end,
				mode = "n",
				desc = ".NET build project",
				silent = true,
			},
			{
				"<leader>nt",
				function()
					run_dotnet_for_project("test")
				end,
				mode = "n",
				desc = ".NET test project",
				silent = true,
			},
			{
				"<leader>nT",
				function()
					run_dotnet_for_target("test")
				end,
				mode = "n",
				desc = ".NET test target",
				silent = true,
			},
			{
				"<leader>ns",
				function()
					run_dotnet_for_target("restore")
				end,
				mode = "n",
				desc = ".NET restore target",
				silent = true,
			},
			{
				"<leader>nr",
				function()
					run_dotnet_for_project("run --project")
				end,
				mode = "n",
				desc = ".NET run project",
				silent = true,
			},
			...
			},
			{
				...
				mode = { "n", "v" },
				desc = ".NET remove project package",
				silent = true,
			},
		},
		opts = {
