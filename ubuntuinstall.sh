...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/williamguilhermesouza/dotfiles/master/ubuntuinstall.sh)"
# or wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/williamguilhermesouza/dotfiles/master/ubuntuinstall.sh)"
#
...
sudo apt install gconf-service fonts-firacode zsh dconf-cli silversearcher-ag neovim git -y
