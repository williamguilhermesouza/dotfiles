...
$pairs = @(
  ...
  @{ Source = (Join-Path $configRoot "powershell\profile.ps1"); Target = (Join-Path $HOME "Documents\PowerShell\Microsoft.PowerShell_profile.ps1") }
  @{ Source = (Join-Path $configRoot "powershell\profile.ps1"); Target = (Join-Path $HOME "Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1") }
)
